import hashlib, os, datetime, sys, time, ctypes
...
# scan.py for Python 3.2

# Made by the Backdoor Interactive Hacking Team!
# Phoenix (Michael), Gamma_games (Ben), Adko5558 (Adrian), Theprebeta, Hinata, and a few more who inspired me with ideas! Thank you everyone!

# Copyright (c) 2026 Backdoor Interactive!
...
print("scan.exe -- SCNAV File Scanner")
...
def fileoperation(mode,filename,buffer="data",line=0):
    ...
    if mode == 4:
        ...
        try:
            ...
            print("Error loading the file: " + filename +" make sure everything is updated")
            return set()
...
def scan():
    ...
    #    lowrammode = 1
    if scanpath == "webvirustotallol": # VT Mode
        client = vt.Client("ae")
    ...
    if isadmin():
        ...
        history = timestamp + " Scanned in " + scanpath + "\n" # Python 3.2 compatibility
        ...
        def scan_file(filepath, malware_hashes, filename, lowrammode):
            ...
            try:
                    ...
                    with open(malware_hashes) as mdb:
                        for line in mdb:
                            if file_hash in line:
                                ...
                                messagethreat = "[" + timestamp + "]" + " Threat detected: " + filename + " Location: " + filepath + " (Hash: " + file_hash + ")"
                                print(messagethreat)
                ...
                print("Error scanning: the file path here")
        ...
        hash_file = "C:\\Program files\\SCNAV2025\\bases.txt"  # MD5 Malware Database
        ...
        try:
            if sys.argv[2] == "activescan":
                ...
                if threatcount == 0 or threatcount < 0:
                    ...
                    sys.exit()
                    return 0
                text ='WARNING! SCNAV Real Time Protection has detected ' + str(threatcount) + " or more potentionally malicious threat(s)!\nScanned Location: " + directory_to_scan
                #style = 16
            ...
            print("Scan finished. See quarentine for any detected threats.")
            time.sleep(5)
        print("Scan finished")
    else:
        ctypes.windll.shell32.ShellExecuteW(None, "runas", sys.executable, " ".join(sys.argv), None, 1)
