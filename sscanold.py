...
try:
    ...
    print("Error on loading threat.mp3 sound file")
    time.sleep(3)
    ...
    if isadmin():
                ...
                if file_hash in malware_hashes:
                    ...
                    try:
                        ...
                        try:
                            ...
                            print("Error on playing threat.mp3 sound file")
        ...
        try:
            if sys.argv[2] == "activescan":
                ...
                text =f'WARNING! SCNAV Real Time Protection has detected {threatcount} threats! Click OK to open SCNAV GUI'
                style = 16
                ctypes.windll.user32.MessageBoxW(0, text, title, style)
                os.system("start SCNAV.exe")
                return 0
                time.sleep(5)
        except:
